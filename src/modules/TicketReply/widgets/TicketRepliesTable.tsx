...
import TicketRepliesTableFilter from "./TicketRepliesTableFilter";
...
interface ITicketRepliesTableProps {
  tableId: string;
  trashed: boolean;
  ticketReplies: ITicketReplyModel[];
  ...
  onFilter: TOnFilter;
  loading: boolean;
  onDelete: TOnDelete<ITicketReplyModel> | TOnForceDelete<ITicketReplyModel>;
  loadingDelete: boolean;
  onRestore: TOnRestore<ITicketReplyModel>;
  loadingRestore: boolean;
  onEdit: TOnEdit<ITicketReplyModel>;
  onStatusUpdate: TOnUpdate<ITicketReplyModel>;
  onTypeUpdate: TOnUpdate<ITicketReplyModel>;
  onExport: TOnExport;
}

const TicketRepliesTable: React.FC<ITicketRepliesTableProps> = ({
  tableId,
  trashed,
  ticketReplies,
  paginate,
...
export default TicketRepliesTable;
