...
interface IPermissionsTableProps {
  ...
  onFilter: TOnFilter;
  loading: boolean;
  onDelete: TOnDelete<IPermissionModel> | TOnForceDelete<IPermissionModel>;
  loadingDelete: boolean;
  onRestore: TOnRestore<IPermissionModel>;
  loadingRestore: boolean;
  onEdit: TOnEdit<IPermissionModel>;
  onStatusUpdate: TOnUpdate<IPermissionModel>;
  onTypeUpdate: TOnUpdate<IPermissionModel>;
  onExport: TOnExport;
}
...
const PermissionsTable: React.FC<IPermissionsTableProps> = ({
  ...
  const t = useTranslations("Permission.Widgets.Table");
