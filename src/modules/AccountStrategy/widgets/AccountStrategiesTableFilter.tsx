...
interface IAccountStrategiesTableFilterProps {
  tableId: string;
...
const AccountStrategiesTableFilter: React.FC<IAccountStrategiesTableFilterProps> = ({
  tableId,
  defaultStatusValue,
  defaultTypeValue,
  statuses,
...
export default AccountStrategiesTableFilter;
