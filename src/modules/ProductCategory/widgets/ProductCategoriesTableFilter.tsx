...
interface IProductCategoriesTableFilterProps {
  tableId: string;
...
const ProductCategoriesTableFilter: React.FC<IProductCategoriesTableFilterProps> = ({
  tableId,
  defaultStatusValue,
  defaultTypeValue,
  statuses,
...
export default ProductCategoriesTableFilter;
