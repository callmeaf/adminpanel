...
interface IMediaTableProps {
  ...
  onFilter: TOnFilter;
  loading: boolean;
  onDelete: TOnDelete<IMediaModel> | TOnForceDelete<IMediaModel>;
  loadingDelete: boolean;
  onRestore: TOnRestore<IMediaModel>;
  loadingRestore: boolean;
  onEdit: TOnEdit<IMediaModel>;
  onStatusUpdate: TOnUpdate<IMediaModel>;
  onTypeUpdate: TOnUpdate<IMediaModel>;
  onExport: TOnExport;
}

const MediaTable: React.FC<IMediaTableProps> = ({
  tableId,
  trashed,
  media,
  paginate,
  ...
  const t = useTranslations("Media.Widgets.Table");
