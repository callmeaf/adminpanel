...
interface IMediaInfoFormProps extends IForm {
  media?: IMediaModel;
}

const MediaInfoForm: React.FC<IMediaInfoFormProps> = ({
  onSubmit,
  loading,
  media,
}) => {
 ...
 const {
    statuses,
    types,
  } = localStorageArtisan.enums(EnumSource.MEDIA)
  ...
  const {
    ...
    resolver: yupResolver(schema),
      ...
      status: media?.statusObject(statuses),
      type: media?.typeObject(types),
    },
  });
